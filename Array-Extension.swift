extension Array {
  ...
  /**
   Increases the index of an array by 1. When the index would go out of
   the array it will be set to the beginning of the array
  ...
  /**
   Increases the index of an array by 1. When the index would go higher
   than the set maximum it will be set to the beginning of the array
   - parameters:
  ...
  /**
  Decreases the index of an array by 1. When the index would go out of
  the array it will be set to the end of the array
  ...
  /**
   Decreases the index of an array by 1. When the index would go lower
   than than 0 it will be set to the maximum index
   - parameters:
